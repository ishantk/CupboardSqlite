...
import edureka.cupboardapp.content.BooksContentProvider;
import edureka.cupboardapp.model.Book;
...
public class BookActivity extends ListActivity implements LoaderCallbacks<Cursor> {
    ...
    private static class BooksAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            book.author = cupboard().withContext(context).get(BooksContentProvider.AUTHOR_URI, book.author);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        loader.setUri(BooksContentProvider.BOOKS_URI);
        return loader;
    }
